...
public class ProductController 
{
 ...
 public ResponseEntity<ProductResponse> getProduct(@PathVariable Long productId) throws ProductServiceException
 {
 ...
 public ResponseEntity<Void> reduceQuantity(@PathVariable ("id")Long productId,@RequestParam(required = false) int quantity) throws ProductServiceException
 {
